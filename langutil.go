...
// ISO639NameToThreeLower is ISO639NameToThree with lowercased keys, for case
// insensitive lookups.
var ISO639NameToThreeLower = func() map[string]string {
	m := make(map[string]string, len(ISO639NameToThree))
	for k, v := range ISO639NameToThree {
