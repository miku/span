...
install -m 755 span-crossref-fastproc $RPM_BUILD_ROOT/usr/local/bin
...
install -m 755 span-mail $RPM_BUILD_ROOT/usr/local/bin
...
/usr/local/bin/span-crossref-fastproc
